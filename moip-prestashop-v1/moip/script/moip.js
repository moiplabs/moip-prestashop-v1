            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data.redirect) {
                        ...
                        $("#p_warning").append('<span class="warning_line"><br>Verifique os dados preenchidos ou se preferir utilize outro cartão.</span>');

                        if(data.classification){
                        //$("#p_warning").append('<span class="warning_line"><br>Motivo: '+ data.classification +'</span>');
                        }
                        $('.div_debito_moip').fadeOut();
                        $('.div_boleto_moip').fadeOut();
                        enableButton(paymentMethod);
